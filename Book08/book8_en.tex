...
\addcontentsline{toc}{chapter}{Book 8}
\pagestyle{plain}
\begin{center}
...
\gr{>E`an >~wsin <osoidhpoto~un >arijmo`i <ex~hc >an'alogon, o<i  d`e >'akroi a>ut~wn pr~wtoi pr`oc >all'hlouc >~wsin, >el'aqisto'i e>isi t~wn t`on
a>ut`on l'ogon >eq'ontwn a>uto~ic.}\\

\epsfysize=0.9in
\centerline{\epsffile{Book08/fig01g.eps}}

\gr{>'Estwsan <oposoio~un >arijmo`i <ex~hc >an'alogon o<i A, B, G,
D, o<i d`e >'akroi a>ut~wn o<i A, D, pr~wtoi pr`oc >all'hlouc
>'estwsan; l'egw, <'oti o<i A, B, G, D >el'aqisto'i e>isi
t~wn t`on a>ut`on l'ogon >eq'ontwn a>uto~ic.}

\gr{E>i g`ar m'h, >'estwsan >el'attonec t~wn A, B, G, D
o<i E, Z, H, J >en t~w| a>ut~w| l'ogw| >'ontec a>uto~ic. ka`i
>epe`i o<i A, B, G, D >en t~w| a>ut~w| l'ogw|
e>is`i to~ic
...
d`e >el'aqistoi >arijmo`i metro~usi to`uc t`on a>ut`on l'ogon
...
G, D >en t~w| a>ut~w| l'ogw| e>is`in a>uto~ic. o<i A, B, G,
D >'ara >el'aqisto'i e>isi t~wn t`on a>ut`on l'ogon >eq'ontwn a>uto~ic;
<'oper >'edei de~ixai.}}
...
<'oti ka`i >el'aqistoi. >epe`i g`ar o<i A, B >el'aqisto'i e>isi t~wn t`on a>ut`on
l'ogon >eq'ontwn a>uto~ic, o<i d`e >el'aqistoi t~wn t`on a>ut`on l'ogon
...
<ex~hc >an'alogon, o<i d`e >'akroi a>ut~wn pr~wtoi pr`oc >all'hlouc
>~wsin, >el'aqisto'i e>isi t~wn t`on a>ut`on l'ogon >eq'ontwn a>uto~ic.
o<i G, D, E >'ara ka`i o<i Z, H, J, K >el'aqisto'i e>isi t~wn t`on a>ut`on
...
>el'aqistoi >~wsi t~wn t`on a>ut`on l'ogon >eq'ontwn a>uto~ic, o<i
>'akron a>ut~wn tetr'agwno'i e>isin, >e`an d`e t'essarec, k'uboi.
}}
...
t~wn t`on a>ut`on l'ogon >eq'ontwn a>uto~ic, o<i >'akroi
a>ut~wn pr~wtoi pr`oc >all'hlouc e>is'in.}\\

\epsfysize=2in
\centerline{\epsffile{Book08/fig03g.eps}}

\gr{>'Estwsan <oposoio~un >arijmo`i <ex~hc >an'alogon >el'aqistoi
t~wn t`on a>ut`on l'ogon >eq'ontwn a>uto~ic o<i A, B, G, D;
l'egw, <'oti o<i >'akroi a>ut~wn o<i A, D pr~wtoi pr`oc >all'hlouc
e>is'in.}
...
\gr{Ka`i >epe`i o<i E, Z >el'aqisto'i e>isi  t~wn t`on a>ut`on l'ogon >eq'ontwn
a>uto~ic, pr~wtoi pr`oc >all'hlouc e>is'in. ka`i >epe`i <ek'ateroc t~wn
...
e>isi t~wn t`on a>ut`on l'ogon >eq'ontwn a>uto~ic, e>is`i
d`e ka`i o<i L, M, N, X >el'aqistoi >en t~w| a>ut~w| l'ogw| >'ontec
...
>'ara <wc <o A pr`oc t`on B, o<'utwc <o J pr`oc t`on H. di`a t`a a>ut`a d`h ka`i <wc <o G pr`oc t`on D, o<'utwc <o H pr`oc t`on K, ka`i >'eti <wc <o
...
ka`i >el'aqistoi. e>i g`ar m'h e>isin o<i J, H, K, L
...
a>ut`on l'ogon >'eqontac >is'akic <'o te me'izwn t`on me'izona ka`i <o >el'asswn t`on >el'assona, tout'estin <'o te <hgo'umenoc t`on <hgo'umenon ka`i <o <ep'omenoc t`on <ep'omenon, <o B >'ara t`on X metre~i. di`a t`a
a>ut`a d`h ka`i <o G t`on X metre~i; o<i B, G >'ara t`on X metro~usin;
...
\gr{M`h metre'itw d`h <o E t`on K, ka`i e>il'hfjw <up`o t~wn E, K >el'aqistoc
...
t`a a>ut`a d`h ka`i <wc <o G pr`oc t`on D, o<'utwc <o X pr`oc t`on M. p'alin,
...
>el'aqistoi >en to~ic A B, G D, E Z l'ogoic. e>i  g`ar m'h, >'esonta'i tinec t~wn N, X, M, O
...
metro~usi to`uc t`on a>ut`on l'ogon >'eqontac
a>uto~ic >is'akic <'o te <hgo'umenoc t`on <hgo'umenon ka`i <o <ep'omenoc
t`on <ep'omenon, <o B >'ara t`on R metre~i. di`a t`a a>ut`a d`h ka`i <o G t`on
...
>all`a m`hn ka`i t`on Z pollaplasi'asac t`on B 
pepo'ihken, >'estin
...
t`on de'uteron m`h metr~h|, o>ud`e >'alloc o>ude`ic o>ud'ena metr'hsei.}\\

\epsfysize=2in
\centerline{\epsffile{Book08/fig06g.eps}}

\gr{>'Estwsan <oposoio~un >arijmo`i <ex~hc >an'alogon o<i A, B, G, D, E,
<o d`e A t`on B m`h metre'itw; l'egw, <'oti o>ud`e >'alloc o>ude`ic
o>ud'ena metr'hsei.}
...
>arijmo`i t~wn t`on a>ut`on l'ogon >eq'ontwn to~ic A, B, G o<i Z, H,
J. ka`i >epe`i o<i Z, H, J >en t~w| a>ut~w| l'ogw| e>is`i to~ic A, B, G,
...
>arijmo'i, <'osoi e>ic a>uto`uc metax`u kat`a t`o suneq`ec >an'ologon >emp'iptousin >arijmo'i, toso~utoi ka`i e>ic to`uc t`on a>ut`on l'ogon
>'eqontac [a>uto~ic] metax`u kat`a t`o sun`eqec >an'alogon >empeso~untai}
...
A, G, D, B o<i H, J, K, L; o<i >'ara >'akroi a>ut~wn o<i H, L pr~wtoi pr`oc
>all'hlouc e>is'in. ka`i >epe`i o<i A, G, D, B to~ic H, J, K, L >en t~w| a>ut~w| l'ogw| e>is'in, ka'i >estin >'ison t`o pl~hjoc t~wn
...
>arijmo`i metro~usi to`uc t`on a>ut`on l'ogon >'eqontac >is'akic <'o te me'izwn t`on me'izona ka`i <o >el'asswn t`on >el'assona, tout'estin <'o te
...
>'ara to~ic E, M, N, Z >en t~w| a>ut~w| l'ogw| e>is'in. >all`a o<i 
H, J, K, L to~ic A, G, D, B >en t~w| a>ut~w| l'ogw| e>is'in; ka`i
o<i A, G,  D, B >'ara to~ic E, M, N, Z >en t~w| a>ut~w| l'ogw|
...
a>uto`uc metax`u kat`a t`o suneq`ec >an'alogon >emp'iptwsin
>arijmo'i, <'osoi e>ic a>uto`uc metax`u kat`a t`o suneq`ec >an'alogon
>emp'iptousin >arijmo'i, toso~utoi ka`i <ekat'erou a>ut~wn ka`i mon'adoc
...
a>uto`uc metax`u kat`a t`o suneq`ec >an'alogon >empipt'etwsan
...
ple'iouc, <'ewc >`an >'ison g'enhtai t`o pl~hjoc a>ut~wn t~w|
...
t`on a>ut`on l'ogon >eq'ontwn to~ic Z, H, e>is`i d`e ka`i o<i A, G, D, B
>el'aqistoi t~wn t`on a>ut`on l'ogon >eq'ontwn to~ic
...
d`e ka`i <h E mon`ac t`on Z kat`a t`ac >en a>ut~w| mon'adac; >is'akic
...
mon`ac t`on Z >arijm`on kat`a t`ac >en a>ut~w| mon'adac; >is'akic
...
suneq`ec >an'alogon >emp'iptwsin >arijmo'i, <'osoi <ekat'erou a>ut~wn
ka`i mon'adoc metax`u kat`a t`o suneq`ec >an'alogon >emp'iptousin >arijmo'i,
toso~utoi ka`i e>ic a>uto`uc metax`u kat`a t`o suneq`ec >an'alogon
>empeso~untai.}
...
t`a a>ut`a d`h ka`i <o m`en Z <eaut`on pollaplasi'asac t`on H pepo'ihken,
t`on d`e H pollaplasi'asac t`on B pepo'ihken. ka`i >epe`i <o D
<eaut`on m`en pollaplasi'asac t`on E pepo'ihken, t`on d`e Z pollaplasi'asac t`on  J pepo'ihken, >'estin >'ara <wc <o D pr`oc t`on Z, o<'utwc <o E pr`oc t`on J. di`a t`a a>ut`a
...
>estin <o A, pleur`a d`e a>uto~u >estin <o G, <o G >'ara <eaut`on
pollaplasi'asac t`on A pepo'ihken. di`a t`a a>ut`a
...
t`a a>ut`a d`h ka`i <wc <o G pr`oc t`on D, o<'utwc <o E pr`oc t`on B.
...
\gr{Ka`i >epe`i k'uboc >est`in <o A, pleur`a d`e a>uto~u <o G, ka`i <o G
...
pepo'ihken. di`a t`a a>ut`a d`h ka`i <o D <eaut`on m`en pollaplasi'asac
...
t`on Z. di`a t`a a>ut`a d`h ka`i <wc <o G pr`oc t`on D, o<'utwc 
...
a>ut~wn >an'alogon >'esontai; ka`i >e`an o<i >ex >arq~hc to`uc
genom'enouc pollaplasi'asantec poi~ws'i tinac, ka`i a>uto`i >an'alogon
...
>en t~w| a>ut~w| l'ogw| e>is`i ka`i >'eti o<i H, M, N, J to~ic J, O, P,
...
\gr{>'Estwsan tetr'agwnoi >arijmo`i o<i A, B, pleura`i d`e a>ut~wn >'estwsan
...
\gr{T~wn g`ar a>ut~wn kataskeuasj'entwn <omo'iwc d`h de'ixomen, <'oti
...
\gr{>E`an tetr'agwnoc >arijm`oc tetr'agwnon >arijm`on m`h metr~h|, o>ud`e
<h pleur`a t`hn pleur`an metr'hsei; k>`an <h pleur`a t`hn pleur`an  m`h
...
\gr{>'Estwsan tetr`agwnoi >arijmo`i o<i A, B, pleura`i d`e a>ut~wn >'estwsan
o<i G, D, ka`i m`h metre'itw <o A t`on B; l`egw, <'oti o>ud`e <o G t`on D
metre~i.}

\gr{E>i g`ar metre~i <o G t`on D, metr'hsei ka`i <o A t`on B. o>u metre~i
d`e <o A t`on B; o>ud`e >'ara <o G t`on D metr'hsei.}

\gr{M`h metre'itw [d`h] p'alin <o G t`on D; l'egw, <'oti o>ud`e <o A t`on B
metr'hsei.}
...
\gr{>E`an k'uboc >arijm`oc k'ubon >arijm`on m`h metr~h|, o>ud`e <h
pleur`a t`hn pleur`an metr'hsei; k>`an <h pleur`a t`hn pleur`an
m`h metr~h|, o>ud`e <o k'uboc t`on k'ubon metr'hsei.}\\~\\~\\

\epsfysize=0.5in
\centerline{\epsffile{Book08/fig16g.eps}}

\gr{K'uboc g`ar >arijm`oc <o A k'ubon >arijm`on t`on B
m`h metre'itw, ka`i to~u m`en A pleur`a >'estw <o G, to~u
...
\gr{>All`a d`h m`h metre'itw <o G t`on D; l'egw, <'oti o>ud`e <o
A t`on B metr'hsei.}
...
pleura`i d`e a>uto~u o<i G, D, <o D >'ara t`on G pollaplasi'asac t`on A
pepo'ihken. di`a t`a a>ut`a d`h ka`i <o E t`on Z pollaplasi'asac t`on B
...
pollaplasi'asac t`on L poie'itw. ka`i  >epe`i o<i G, D to`ic Z, H >en t~w| a>ut~w| l'ogw| e>is'in, ka`i >ek m`en t~wn G, D >estin <o K, >ek d`e t~wn
...
di`a t`a a>ut`a d`h ka`i <wc <o D pr`oc t`on H,
...
pollaplasi'asac t`on X pepo'ihken, >all`a m`hn ka`i t`on L pollaplasi'asac
...
<o E t`on G.  <os'akic
d`h <o D t`on A metre~i, tosa~utai mon'adec >'estwsan >en t~w| Z; <o Z >'ara t`on D
pollaplasi'asac t`on A pepo'ihken. <'wste <o A >ep'iped'oc >estin, pleura`i
d`e a>uto~u o<i D, Z. p'alin, >epe`i o<i D, E >el'aqisto'i e>isi t~wn t`on
a>ut`on l'ogon >eq'ontwn to~ic G, B, >is'akic >'ara <o D t`on G
metre~i ka`i <o E t`on B. <os'akic d`h <o E t`on B metre~i, tosa~utai
...
<o B >'ara  >ep'ipedoc >esti, pleura`i d`e a>uto~u e>isin o<i E, H.
...
pleura`i a>ut~wn >an'alog'on e>isin; <'oper >'edei de~ixai.}}
...
\gr{E>il'hfjwsan g`ar >el'aqistoi >arijmo`i t~wn t`on a>ut`on l'ogon >eq'ontwn
to~ic A, G, D tre~ic o<i E, Z, H; o<i >'ara >'akroi a>ut~wn o<i E, H
...
e>isi t~wn t`on a>ut`on l'ogon >eq'ontwn to~ic A, G, D, ka'i >estin
...
to`uc t`on a>ut`on l'ogon >'eqontac a>uto~ic >is'akic <'o te me'izwn
...
t`on A metre~i, tosa~utai mon'adec >'estwsan >en t~w| N. <o N >'ara
...
>'ara >est`in <o A, pleura`i d`e a>uto~u e>isin o<i J, K, N. p'alin, >epe`i
o<i E, Z, H >el'aqisto'i e>isi t~wn t`on a>ut`on l'ogon >eq'ontwn
to~ic G, D, B, >is'akic >'ara <o E t`on G metre~i ka`i <o H t`on B. <os'akic
d`h <o E t`on G metre~i, tosa~utai mon'adec >'estwsan >en t~w| X.
...
pepo'ihken. stere`oc >'ara >est`in <o B, pleura`i d`e a>uto~u e>isin
...
t`on a>ut`on l'ogon >'eqontac a>uto~ic; <'wste ka`i t~wn A, B d'uo
...
t`on a>ut`on l'ogon >eq'ontwn to~ic A, G, B o<i D, E, Z; o<i
>'ara >'akroi a>ut~wn o<i D, Z tetr'agwno'i e>isin. ka`i >epe'i
...
ka`i e>il'hfjwsan >el'aqistoi >arijmo`i t~wn t`on a>ut`on l'ogon >eq'ontwn
to~ic A, G, D, B >'isoi a>uto~ic t`o pl~hjoc o<i E, Z, H, J; o<i >'ara
>'akroi a>ut~wn o<i E, J k'uboi e>is'in. ka'i >estin <wc <o E pr`oc
